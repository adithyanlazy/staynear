...
const VerifyPhone = () => {
  ...
  const handleResend = async () => {
    ...
    try {
      const res = await api.post('/auth/resend-phone-otp', { phone, isLogin });
    ...
    <div className="min-h-screen pt-20 pb-16 flex items-center justify-center">
      <div className="max-w-md w-full mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold">Verify Your Phone</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            We've sent a 6-digit code to
          </p>
          <p className="text-primary-500 font-medium">{phone}</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="mt-4 text-center">
            <Link
              ...
              className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-primary-500"
            >
              <ArrowLeft className="w-4 h-4" />
              {isLogin ? 'Back to Login' : 'Back to Registration'}
            </Link>
          </div>
        </div>
      </div>
