...
// Anchor content globs to this file so scanning works regardless of the cwd
// the dev server is launched from.
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Dark-mode surface scale — single source for the scattered dark hexes
        surface: {
          DEFAULT: '#030e0d',  // page/body
          section: '#07070f',  // alternating section A
          raised:  '#0b0b17',  // alternating section B
          card:    '#0d1f1e',  // cards, sticky bars
          hero:    '#04100f',  // hero mesh base
        },
        accent: {
          50:  '#f5f3ff',
          100: '#ede9fe',
