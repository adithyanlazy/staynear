...
const sendPhoneOTP = async (phone, otp, isLogin = false) => {
  const subject = isLogin
    ? 'StayNear - Login Verification Code'
    : 'StayNear - Phone Verification Code';
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
        <h2 style="color: #1f2937; text-align: center;">${isLogin ? 'Login Verification' : 'Phone Verification'}</h2>
        ...
        <p style="color: #6b7280; text-align: center; font-size: 14px;">This code expires in 5 minutes.</p>
